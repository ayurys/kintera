...
user_func1 func1_table_cpu[] = {
    ...
    zns_visscher,    zns_visscher_ddT,   na_h2s_visscher, na_h2s_visscher_ddT};
...
std::vector<std::string> func1_names = {
    ...
    "kcl_lodders",        "kcl_lodders_ddT",   "zns_visscher",
    "zns_visscher_ddT",   "na_h2s_visscher",   "na_h2s_visscher_ddT"};
